...
def personal_account_to_public(account: PersonalAccount) -> dict:
    ...
    return {
        ...
        "plan_renews_at": account.plan_renews_at,
        "last_plan_sync_at": account.last_plan_sync_at,
        "next_plan_sync_at": account.next_plan_sync_at,
        "plan_sync_error": account.plan_sync_error,
        "plan_sync_fail_count": account.plan_sync_fail_count or 0,
